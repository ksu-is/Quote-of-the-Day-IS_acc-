...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.entry = Entry(master, width=50, font=("Arial",25))
        self.entry.grid(row=0, column=0, columnspan=6, sticky="w")
        self.entry.focus_set()
        self.entry.configure(state="disabled", disabledbackground="tan", disabledforeground="black")
        self.create_widgets()
    ...
    def bind_buttons(self, master):
        ...
        master.bind(sun_func,lambda event, char="Sunday", btn=self.sunday_bttn: self.add_chr(char,btn))
    ...
    def create_widgets(self):
        ...
        self.sunday_bttn=Button(self,text='Sunday', width=9, height=3,command=lambda: self.clear())
        self.sunday_bttn.grid(row=4, column=2)
